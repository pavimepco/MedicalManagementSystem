...
<body>
     ...
     <div class="top_menu row m0">
            <div class="container">
                <div class="float-left">
                    <a class="dn_btn" href="mailto:medcare@gmaail.com"><i class="ti-email"></i>medcare@gmaail.com</a>
                        ...
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item submenu dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="nav-item"><a class="nav-link" href="BloodBank.html">Blood Bank</a></li>
    ...
    <section class="banner-area d-flex align-items-center">
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-lg-6 col-xl-5" style="margin-top: -120px !important">
                    <h1>Making Health<br>
                    Care Better Together</h1>
                    <p>Also you dry creeping beast multiply fourth abundantly our itself signs bring our. Won form living. Whose dry you seasons divide given gathering great in whose you'll greater let livein form beast  sinthete
                    better together these place absolute right.</p>
                    <a href="Book.html" class="main_btn">Make an Appointment</a>
                    <a href="doctors.html" class="main_btn_light">Find a Doctor</a>
                </div>
            </div>
        </div>
    </section>
